...
# Create persistance host volume if your cluster is on VirtualBox or cloud provided Storage Volume.
 ...
 3 nodes. First, create a directory on each of the nodes to store Cassandra data. For example /data/cass/. 
 Make sure 10 GB of storage is available in this directory on each node. Create this directory on each of the three nodes, on each site.
